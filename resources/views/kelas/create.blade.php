...
<div class="max-w-md mx-auto bg-white rounded-lg shadow-md p-6">
    ...
    <form action="{{ route('mataKuliah.index') }}" method="post" class="space-y-4">
        @csrf
        <div>
            <label for="kode_matkul" class="block text-gray-700 text-sm font-bold mb-2">Kode Kelas</label>
        ...
        <div>
            <label for="nama_matkul" class="block text-gray-700 text-sm font-bold mb-2">Nama Kelas</label>
