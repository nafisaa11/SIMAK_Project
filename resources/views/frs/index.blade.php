...
@section('content')
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="flex justify-between items-center px-6 py-4 border-b border-gray-200 bg-gray-50">
            <!-- Bagian kiri: data mahasiswa ditumpuk ke bawah -->
            <div class="flex justify-between items-center px-6 py-4 border-gray-200 bg-gray-50">
                        ...
                        <tr class="hover:bg-gray-100 transition-colors duration-200">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex space-x-2">
                                    <a href="{{ route('frs.edit', $frs->id) }}"
                                        class="bg-yellow-400 hover:bg-yellow-500 text-black p-2 rounded" title="Edit">
                                        <i class="ph ph-pencil"></i>
                                    </a>
                                    <form action="{{ route('frs.destroy', $frs->id) }}" method="POST"
